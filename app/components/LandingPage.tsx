...
const PANEL_CONFIG: Record<string, PanelConfig> = {
  ...
  "mapa-2":  { label: "Noční dostihy",  emoji: "🌙",  desc: "Connecticut, 1925. Skutečné peníze neběhají na slunci.",                                                                             teaser: "Starý ovál, déšť, doutníky a závody po půlnoci. V noci nestačí vyhrát — musíš získat všechny koně.",                                                          bgImage: "/bg_horse_night.webp",   themeId: "horse-night",   available: true,  view: "launcher" },
