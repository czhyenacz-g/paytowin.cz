...
const PANEL_CONFIG: Record<string, PanelConfig> = {
  "mapa-1":  { label: "Denní dostihy 1921",  emoji: "🏇",  desc: "Connecticut, 1921. Banka udělala chybu — a ty z ní zkusíš udělat titulní příběh.",                                          teaser: "Začni s půjčenými penězi, kup první racery a přežij sezónu, která tě může dostat na titulní stranu.",                                                         bgImage: "/bg_horse_day.webp",     themeId: "horse-day",     boardId: "small-stadium", available: true,  view: "launcher" },
  "mapa-2":  { label: "Noční dostihy 1925",  emoji: "🌙",  desc: "Connecticut, 1925. Přes den se závodí. V noci se vydělává.",                                                                             teaser: "Starý ovál, déšť, doutníky a závody po půlnoci. V noci nestačí vyhrát — musíš získat všechny koně.",                                                          bgImage: "/bg_horse_night.webp",   themeId: "horse-night",   available: true,  view: "launcher" },
  "mapa-3":  { label: "Chuchle 1930",   emoji: "🏇",  desc: "Velká Chuchle, 1930. V Americe jsi přišel o vše. Poslední záchrana mohou být tvé kořeny v Československu.",                        teaser: "Po Černém pátku prodáš, co zbylo, a za poslední peníze utečeš ke kořenům. Ne jako vítěz — spíš jako člověk, který ještě odmítá skončit.",                    bgImage: "/bg_horse_classic.webp", themeId: "horse-classic", available: true,  view: "launcher" },
  "mapa-4":  { label: "Denní auta 1934",     emoji: "🏎️", desc: "Československo, 1934. Od stájí ke garážím, od ovsa k benzínu, od žokejů k řidičům.",                                               teaser: "Koně ti dali druhou šanci, ale svět už burácí motory. Založ garáž a zjisti, jestli se dá prohrát ještě rychleji.",                                             bgImage: "/bg_car_day.webp",       themeId: "car-day",       available: true,  view: "launcher" },
  "mapa-5":  { label: "Noční auta 1936",     emoji: "🌃",  desc: "1936. Skutečné závody začínají až po zavření bran.",                                                                                 teaser: "Motory, mlha, benzín a lidé, kteří tvrdí, že nesází — jen investují do rychlosti. Staré chyby se vrací, jen jedou rychleji.",                                  bgImage: "/bg_car_night.webp",     themeId: "car-night",     available: true,  view: "launcher" },
            ...
            <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-4 sm:px-6 py-4 sm:py-8">
              ...
              <div
                ...
                <div className="flex items-center justify-center gap-4 text-xs text-slate-400">
                  ...
                  <span>·</span>
                  <a href="/testeri" className="hover:text-slate-200 underline">Hledám testery</a>
                  <span>·</span>
                  <a href="mailto:info@paytowin.cz" className="hover:text-slate-200 underline">info@paytowin.cz</a>
                  <span>·</span>
                  <span className="rounded-full bg-amber-500/20 px-2 py-0.5 text-[10px] font-semibold text-amber-400 tracking-wide">Beta v0.7.18-seno</span>
                </div>
              </div>
            </div>
          </div>
