...
export default function MajorGainOverlay({ amount, onDismiss }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/leonardo-dicaprio-cheers-meme-template-thumbnail-8d2025f1.webp"
          alt=""
        ...
        <div className="text-2xl font-black text-emerald-400 tabular-nums">+{amount.toLocaleString("cs-CZ")} 💰</div>
      </div>
    </div>
  );
}
