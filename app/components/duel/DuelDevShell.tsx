...
export default function DuelDevShell({ onExit }: Props) {
  ...
  const [configKey, setConfigKey] = React.useState(0); // force DuelArena remount on config change
      ...
      <div className="flex flex-1 gap-4 p-4 overflow-hidden">
        ...
        <div className="w-52 shrink-0 flex flex-col gap-4 overflow-y-auto">
          ...
          <div className="rounded-xl bg-slate-900 border border-slate-800 p-3 space-y-2">
            <div className="text-[9px] font-bold uppercase tracking-widest text-slate-600 mb-1">Režim</div>
