...
export const carNightTheme: Theme = {
  ...
  colors: {
    ...
    arenaGradient:    "url('/bg_car_night_1.webp') center / cover no-repeat",
    arenaGradientAlt: "url('/bg_car_night_2.webp') center / cover no-repeat",
  },
  labels: {
  ...
  racers: [
    ...
    },
    {
      ...
      "emoji": "🏎️",
      "maxStamina": 100,
      "flavorText": "Rychlý, levný a lehce nepochopitelný. Jako táta.",
