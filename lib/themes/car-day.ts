...
export const carDayTheme: Theme = {
  ...
  racers: [
    {
      ...
      "emoji": "🚗",
      "maxStamina": 100,
      "flavorText": "Přijede poslední — ale přijede. A bez proseb o servis.",
    ...
    },
    {
      ...
      "emoji": "🏎️",
      "maxStamina": 100,
      "flavorText": "Střela v názvu, tramvaj v srdci. Hrdá na to.",
    ...
    },
    {
      ...
      "emoji": "🔥",
      "maxStamina": 100,
      "flavorText": "Démon? Spíš čertík. Ale dojet do cíle umí.",
  ...
  content: {
    cards: {
      chance: [
        {
          id: "car_day_chance_1",
          type: "chance",
          text: "Rychlost nebyl problém. Problém byl až ta zatáčka.",
        ...
        },
        {
          id: "car_day_chance_2",
          type: "chance",
          text: "Brzdil jsi poslední. Tentokrát to byla strategie, ne omyl.",
        ...
        },
        {
          id: "car_day_chance_3",
          type: "chance",
          text: "Z boxů křičí, že jedeš všude, jen ne po ideální stopě. Ale pořád jedeš.",
        ...
        },
        {
          id: "car_day_chance_4",
          type: "chance",
          text: "Před startem jsi pronesl hrdinský projev. Auto odpovědělo kašlem.",
        ...
        },
        {
          id: "car_day_chance_5",
          type: "chance",
          text: "Auto dneska chtělo závodit víc než ty.",
          effect: { kind: "move", value: 2 },
          effectLabel: "+2 pole",
        },
        {
          id: "car_day_chance_6",
          type: "chance",
          text: "Startér zvedl praporek, strážník obočí a ty rychlost.",
          effect: { kind: "move", value: 3 },
          effectLabel: "+3 pole",
        },
        {
          id: "car_day_chance_7",
          type: "chance",
          text: "Silniční kontrola zdržela celé startovní pole. Ty jsi zrovna stál nejlíp.",
          effect: { kind: "move", value: 2 },
          effectLabel: "+2 pole",
        },
        {
          id: "car_day_chance_8",
          type: "chance",
          text: "Pneumatiky kvílely, diváci tleskali a mechanik začal počítat škody.",
          effect: { kind: "move", value: -1 },
          effectLabel: "-1 pole",
        },
      ],
      finance: [
        {
          id: "car_day_finance_1",
          type: "finance",
          text: "Mechanik říká, že auto má duši. A že tvoje duše mu dluží za opravu.",
          effect: { kind: "coins", value: -800 },
          effectLabel: "-800 💰",
        },
        {
          id: "car_day_finance_2",
          type: "finance",
          text: "Tovární tým si všiml tvého času. Posílá zálohu a tři lidi s poznámkovým blokem.",
          effect: { kind: "coins", value: 1200 },
          effectLabel: "+1200 💰",
        },
        {
          id: "car_day_finance_3",
          type: "finance",
          text: "Tuning přidal výkon. Účet přidal bolest.",
          effect: { kind: "coins", value: -900 },
          effectLabel: "-900 💰",
        },
        {
          id: "car_day_finance_4",
          type: "finance",
          text: "Sponzorům se líbilo, že jsi dojel. Detaily o brzdách zatím neřešili.",
          effect: { kind: "coins", value: 1000 },
          effectLabel: "+1000 💰",
        },
        {
          id: "car_day_finance_5",
          type: "finance",
          text: "Nové pneumatiky drží skvěle. Peněženka už méně.",
          effect: { kind: "coins", value: -700 },
          effectLabel: "-700 💰",
        },
        {
          id: "car_day_finance_6",
          type: "finance",
          text: "Automobilka ti půjčila lepší vůz. Prý jen aby viděla, jestli ho přežiješ.",
          effect: { kind: "coins", value: 1500 },
          effectLabel: "+1500 💰",
        },
        {
          id: "car_day_finance_7",
          type: "finance",
          text: "Palivo zdražilo přesně ve chvíli, kdy ses rozhodl trénovat víc.",
          effect: { kind: "coins", value: -600 },
          effectLabel: "-600 💰",
        },
        {
          id: "car_day_finance_8",
          type: "finance",
          text: "Tisk tě nazval budoucností motorismu. Sponzor to vzal doslova.",
          effect: { kind: "coins", value: 1300 },
          effectLabel: "+1300 💰",
        },
      ],
      mafia: [
        {
          id: "car_day_police_slot_1",
          type: "finance",
          text: "Dopravní policie ocenila tvůj průjezd. Bohužel podle sazebníku.",
          effect: { kind: "coins", value: -700 },
          effectLabel: "-700 💰",
        },
        {
          id: "car_day_police_slot_2",
          type: "chance",
          text: "Strážník na křižovatce mávl tak dramaticky, že ti otevřel ideální stopu.",
          effect: { kind: "move", value: 2 },
          effectLabel: "+2 pole",
        },
        {
          id: "car_day_police_slot_3",
          type: "finance",
          text: "Pokuta za rychlost. Tvrdíš, že jen testuješ budoucnost dopravy.",
          effect: { kind: "coins", value: -800 },
          effectLabel: "-800 💰",
        },
        {
          id: "car_day_police_slot_4",
          type: "chance",
          text: "Silniční kontrola zdržela celé startovní pole. Ty jsi zrovna stál nejlíp.",
          effect: { kind: "move", value: 2 },
          effectLabel: "+2 pole",
        ...
        {
          id: "car_day_police_slot_5",
          type: "finance",
          text: "Technická kontrola našla závadu. Mechanik tvrdí, že to je charakter.",
          effect: { kind: "coins", value: -900 },
          effectLabel: "-900 💰",
        },
        {
          id: "car_day_police_slot_6",
          type: "chance",
          text: "Startér zvedl praporek, strážník obočí a ty rychlost.",
          effect: { kind: "move", value: 3 },
          effectLabel: "+3 pole",
